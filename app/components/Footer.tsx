            ...
            <div className="space-y-5">
              <div>
                <h4 className="text-white font-serif text-base font-bold tracking-wide flex items-center gap-1.5 uppercase">
                  <SquareTerminal className="w-4 h-4 text-white" /> Window Horizons Corp
                </h4>
              ...
              <p className="text-white font-serif italic text-xs sm:text-sm font-semibold tracking-wide pt-4 border-t border-black/10 flex items-center gap-2">
                <MapPin className="w-3.5 h-3.5 text-white" /> Serving Manhattan & Bergen County
              </p>
            </div>
          </div>
        ...
        <div className="pt-16 pb-6 flex flex-col items-center text-center">
          <div className="flex items-center gap-3 text-white mb-4">
            ...
            <div className="flex flex-col text-left">
              <span className="font-sans font-black text-lg tracking-tight leading-none text-white">HunterDouglas</span>
              <span className="font-sans font-bold text-[9px] tracking-[0.35em] uppercase text-white mt-0.5 leading-none">Authorized Dealer</span>
            </div>
          </div>

          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-4 text-[13px] font-sans text-white font-medium">
            <a href="#" className="hover:text-white/80 hover:underline transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-white/80 hover:underline transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-white/80 hover:underline transition-colors">Sitemap</a>
          </div>
