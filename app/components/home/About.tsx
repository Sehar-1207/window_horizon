  ...
  return (
    <section className="w-full bg-[#faf6f0] text-[#3c332a] font-serif overflow-hidden">
      ...
      <div className="w-full border-b border-[#ebd9c7] px-4 py-4 md:py-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-8 text-xs sm:text-sm tracking-wide text-[#5a4f43]">
          ...
          <div className="flex items-center gap-2.5">
            {/* Custom Hunter Douglas Style Target Icon */}
      ...
      <div className="w-full max-w-4xl mx-auto px-4 py-16 md:py-24 text-center flex flex-col items-center">
        ...
        {/* CTA Button Element */}
        <div className="mt-10 md:mt-12 w-sm xs:w-auto">
          <button 
            className={`${BRAND_GRADIENT} w-sm xs:w-auto px-8 py-4 sm:px-12 text-white font-sans text-xs sm:text-sm font-semibold tracking-[0.12em] uppercase rounded-none shadow-md hover:brightness-105 active:scale-[0.99] transition-all flex items-center justify-center gap-3`}
          >
        ...
        {/* Dynamic Phone Link Component */}
        <a 
          href="tel:8777796060"
          className="mt-6 md:mt-8 flex items-center gap-2 text-[#3c332a] hover:text-[#a38765] transition-colors text-xl sm:text-2xl md:text-[28px] font-normal tracking-wide"
        >
          <Phone className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-[#a38765]" strokeWidth={1.5} />
          <span className="tracking-widest">877-779-6060</span>
        </a>

        {/* Trust & Review Badges Footer */}
