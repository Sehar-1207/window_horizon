...
import Logo from "../assets/service3.jpg";
          ...
          {VIDEOS_DATA.map((video, idx) => {
            ...
            return (
              <div
                ...
                onClick={() => setActiveVideo(uniqueKey)}
              >
                {isActive ? (
                  <iframe
                  ...
                  <>
                    ...
                    <div className="absolute top-3 left-3 right-3 flex items-start gap-2.5 z-10">
                      <div className="w-9 h-9 rounded-full bg-[#1e293b] border border-white/20 flex items-center justify-center flex-shrink-0 overflow-hidden relative">
                        <Image
                    ...
                    <a
                      ...
                      className="absolute bottom-3 right-3 z-30 bg-black/60 hover:bg-black/80 backdrop-blur-sm rounded px-2.5 py-1.5 flex items-center gap-1.5 transition-colors border border-white/10 text-white font-sans text-[11px] sm:text-xs font-medium tracking-normal"
                    >
                      <span>Watch on</span>
                    ...
                    <div className="absolute bottom-3 left-3 z-10 flex items-center gap-3 text-white/90">
                      <button className="p-1.5 hover:text-white transition-colors" onClick={(e) => e.stopPropagation()}>
                        <svg
